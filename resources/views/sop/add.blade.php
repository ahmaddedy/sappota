  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-body">
            <h4 class="card-title mb-3 pb-3 border-bottom">Form Tambah Data SOP</h4>
            @if ($errors->any())
            ...
            @endif
            <form method="POST" action="{{route('master-sop.action-add')}}" enctype="multipart/form-data">
              @csrf
              <div class="row">
                <div class="col-md-12">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="judul" required='required'>
                    <label for="">Judul SOP</label>
                  </div>
                </div>
